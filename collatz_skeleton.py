...
if __name__ == "__main__":
    ...
    #initialize np array
    data = np.zeros((max_number_to_check-1, 2), int) #max_number_to_check-1 bc we start calculating at 2
    for x in numbers_to_check:
        ...
        data[x-2,1] = number_of_steps_to_one(x)
    np.savetxt('collatz_output.txt', data, fmt='%i', delimiter=',', header='n,L(n)')